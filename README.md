...
- [Advanced: Compiling From Source (Optional)](#advanced-compiling-from-source-optional)
  ...
  - [Cross-compiling Linux Intel MUSL Binaries](#cross-compiling-linux-intel-musl-binaries)
...
- [Native Sigma Support](#native-sigma-support)
  ...
  - [Temporal Ordered Rules](#temporal-ordered-rules)
    - [Temporal Ordered Rule Example](#temporal-ordered-rule-example)
