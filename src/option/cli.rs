...
pub struct AwsCtTimelineOptions {
    ...
    /// the number of threads for detecting aws-ct-timeline commands
    #[arg(help_heading = Some("Output"), long = "threads", default_value = "0", hide_default_value = true, value_name = "THREAT NUMBER",)]
