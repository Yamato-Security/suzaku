...
pub enum Action {
    #[clap(
        ...
        help_template = "\nSuzaku v1.0.0 - Dev Build\n{author-with-newline}\n{usage-heading}\n  suzaku.exe csv-timeline <INPUT> [OPTIONS]\n\n{all-args}",
        term_width = 400,
        display_order = 290
    )]
    ...
    #[clap(
        author = "Yamato Security (https://github.com/Yamato-Security/suzaku - @SecurityYamato)",
        help_template = "\nSuzaku v1.0.0 - Dev Build\n{author-with-newline}\n{usage-heading}\n  suzaku.exe json-timeline <INPUT> [OPTIONS]\n\n{all-args}",
        term_width = 400,
        display_order = 360
    )]
    ...
    /// Update to the latest rules in the suzaku-rules github repository
...
#[clap(
    author = "Yamato Security (https://github.com/Yamato-Security/suzaku - @SecurityYamato)",
    help_template = "\nSuzaku v1.0.0 - Dev Build\n{author-with-newline}\n{usage-heading}\n  suzaku.exe <COMMAND> [OPTIONS]\n  suzaku.exe help <COMMAND>\n\n{all-args}{options}",
    term_width = 400
)]
pub struct Config {
    #[command(subcommand)]
