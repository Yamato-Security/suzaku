...
## `aws-ct-summary` कमांड

यह कमांड उपयोगकर्ता ARN के आधार पर निम्नलिखित जानकारी का सारांश बनाता है:
  - इवेंट्स (API कॉल) की कुल संख्या (`NumOfEvents`)
  - लॉग में पाई गई पहली API कॉल का टाइमस्टैम्प (`FirstTimestamp`)
  - लॉग में पाई गई अंतिम API कॉल का टाइमस्टैम्प (`LastTimestamp`)
  - आमतौर पर दुरुपयोग की जाने वाली API कॉल जो सफल रहीं (`AbusedAPIs-Success`)
  - आमतौर पर दुरुपयोग की जाने वाली API कॉल जिनका प्रयास किया गया लेकिन विफल रहीं (`AbusedAPIs-Failed`)
  - अन्य API कॉल जो आमतौर पर दुरुपयोग की जाने वाली API कॉल की सूची में नहीं हैं और जो सफल रहीं (`OtherAPIs-Success`)
  - अन्य API कॉल जो आमतौर पर दुरुपयोग की जाने वाली API कॉल की सूची में नहीं हैं और जिनका प्रयास किया गया लेकिन विफल रहीं (`OtherAPIs-Failed`)
  - AWS क्षेत्र जहाँ API कॉल की गईं (`AWS-Regions`)
  - API कॉल के स्रोत IP पते (`SrcIPs`)
  - उपयोगकर्ता प्रकार (`UserTypes`)
  - उपयोगकर्ता एक्सेस की ID (`UserAccessKeyIDs`)
  - API कॉल करने वाले स्रोत के उपयोगकर्ता एजेंट (`UserAgents`)

※ नोट: आमतौर पर दुरुपयोग की जाने वाली API कॉल कॉन्फ़िग फ़ाइल [https://github.com/Yamato-Security/suzaku-rules/blob/main/config/abused_aws_api_calls.csv](https://github.com/Yamato-Security/suzaku-rules/blob/main/config/abused_aws_api_calls.csv) से आती हैं जो वहाँ होस्ट की गई है। यह फ़ाइल समय के साथ अपडेट होती रहेगी और हर बार जब आप `update-rules` कमांड चलाएँगे तो स्थानीय रूप से सिंक हो जाएगी।

ये परिणाम विश्लेषकों को ऐसी जानकारी प्रदान करने के लिए हैं जिससे वे विशिष्ट सिग्नेचर पर निर्भर हुए बिना समझौता किए गए खातों या हमलों की खोज कर सकें।
उदाहरण के लिए, आप जाँच कर सकते हैं कि क्या कुछ उपयोगकर्ता संदिग्ध API कॉल कर रहे हैं जिन्हें उन्हें नहीं करना चाहिए, ऐसे क्षेत्रों का उपयोग कर रहे हैं जो आमतौर पर उपयोग नहीं किए जाते, संदिग्ध स्रोत IP पतों से या संदिग्ध उपयोगकर्ता एजेंट के साथ लॉग इन कर रहे हैं, आदि...
किसी भी संदिग्ध API कॉल, स्रोत IP पते या उपयोगकर्ता एजेंट का पता चलने के बाद, आप जल्दी से यह निर्धारित कर सकते हैं कि उस समयावधि के दौरान किन एक्सेस की का दुरुपयोग हुआ हो सकता है और हमलावर की गतिविधि की टाइमलाइन बनाने के लिए मूल JSON लॉग में उन कीवर्ड्स पर पिवट कर सकते हैं।

> चेतावनी: सेल में बहुत सारा डेटा होगा और यह संभवतः Excel जैसे प्रोग्राम में अच्छी तरह से प्रदर्शित नहीं होगा। कृपया Mac पर Numbers, Windows पर Timeline Explorer आदि का उपयोग करें...

### `AbusedAPIs-Success` उदाहरण:
```
...
> ध्यान दें कि चूँकि बड़ी मात्रा में अस्थायी AWS STS एक्सेस की ID होंगी, इन्हें डिफ़ॉल्ट रूप से फ़िल्टर कर दिया जाता है। यदि आप इन्हें शामिल करना चाहते हैं तो `-s, --include-sts-keys` विकल्प जोड़ें।
...
> ध्यान दें कि `aws` क्लाइंट टूल उपयोगकर्ता एजेंट में OS की जानकारी शामिल करेगा, इसलिए यह पता लगाना संभव है कि क्या `kali` जैसे हमलावर OS से API कॉल की गई थीं।
...
### `aws-ct-metrics` कमांड उदाहरण

* परिणामों को CSV फ़ाइल में सहेजें: `./suzaku aws-ct-summary -d ../suzaku-sample-data -o sample-summary.csv`
